// Package opera provides a tls-client ClientProfile that emulates
...
// Version is kept for compatibility with callers. The profile is fixed to Opera 131.
type Version int
...
// HeadersFor returns Opera 131's fixed Windows header set.
