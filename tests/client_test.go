...
func chrome116WithPsk(t *testing.T) {
	options := []tls_client.HttpClientOption{
		tls_client.WithClientProfile(profiles.Chrome_116),
...
func chrome103(t *testing.T) {
	options := []tls_client.HttpClientOption{
		tls_client.WithClientProfile(profiles.Chrome_100),
	}
...
func safari_16_0(t *testing.T) {
	options := []tls_client.HttpClientOption{
		tls_client.WithClientProfile(profiles.Safari_18),
	}
...
func safari_iOS_16_0(t *testing.T) {
	options := []tls_client.HttpClientOption{
		tls_client.WithClientProfile(profiles.Safari_IOS_18),
	}
...
func safari_iOS_18_0(t *testing.T) {
	...
	compareResponse(t, "safari ios", clientFingerprints[safariIos][profiles.Safari_IOS_18.GetClientHelloStr()], resp)
}

func firefox_105(t *testing.T) {
	options := []tls_client.HttpClientOption{
		tls_client.WithClientProfile(profiles.Firefox_139),
	}
...
func chrome_146_PSK(t *testing.T) {
	...
	compareResponse(t, "chrome", clientFingerprints[chrome][profiles.Chrome_147.GetClientHelloStr()], resp)
...
func safari_iOS_26_0(t *testing.T) {
	options := []tls_client.HttpClientOption{
		tls_client.WithClientProfile(profiles.Safari_IOS_26),
	}
	...
	compareResponse(t, "safari ios", clientFingerprints[safariIos][profiles.Safari_IOS_26.GetClientHelloStr()], resp)
}
...
func firefox_117(t *testing.T) {
	...
	compareResponse(t, "firefox", clientFingerprints[firefox][profiles.Firefox_139.GetClientHelloStr()], resp)
}
...
func opera_91(t *testing.T) {
	options := []tls_client.HttpClientOption{
		tls_client.WithClientProfile(profiles.Opera_116),
	}
...
func safariIos17(t *testing.T) {
	...
	compareResponse(t, "safari_IOS", clientFingerprints[safariIos][profiles.Safari_IOS_18.GetClientHelloStr()], resp)
}
...
func okhttp4Android13(t *testing.T) {
	options := []tls_client.HttpClientOption{
		tls_client.WithClientProfile(profiles.OkHttp5),
	}
	...
	compareResponse(t, "okhttp4 android 13", clientFingerprints[okhttpAndroid][profiles.OkHttp5.GetClientHelloStr()], resp)
}

func okhttp4Android12(t *testing.T) {
	options := []tls_client.HttpClientOption{
		tls_client.WithClientProfile(profiles.OkHttp4),
	}
	...
	compareResponse(t, "okhttp4 android 12", clientFingerprints[okhttpAndroid][profiles.OkHttp4.GetClientHelloStr()], resp)
}
...
func okhttp4Android11(t *testing.T) {
	...
	compareResponse(t, "okhttp4 android 11", clientFingerprints[okhttpAndroid][profiles.OkHttp4.GetClientHelloStr()], resp)
}
...
func okhttp4Android10(t *testing.T) {
	...
	compareResponse(t, "okhttp4 android 10", clientFingerprints[okhttpAndroid][profiles.OkHttp4.GetClientHelloStr()], resp)
}
...
func okhttp4Android9(t *testing.T) {
	...
	compareResponse(t, "okhttp4 android 9", clientFingerprints[okhttpAndroid][profiles.OkHttp4.GetClientHelloStr()], resp)
}
...
func okhttp4Android8(t *testing.T) {
	...
	compareResponse(t, "okhttp4 android 8", clientFingerprints[okhttpAndroid][profiles.OkHttp4.GetClientHelloStr()], resp)
}
...
func okhttp4Android7(t *testing.T) {
	...
	compareResponse(t, "okhttp4 android 7", clientFingerprints[okhttpAndroid][profiles.OkHttp4.GetClientHelloStr()], resp)
}
